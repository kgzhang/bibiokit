...
import { copyFilesTobibio, getOutput, removeGeneratedFiles, writeOutput } from './linaria';

const force: boolean = cliArgs.force;
const shouldFix: boolean = cliArgs.fix;

const files = globby.sync(['packages/bibio__styles/*.css'], { cwd: baseDir() });
